    ...
    <div class="col-xs-12">
      <div class="box box-secondary">
        <div class="box-header with-border">
          <h3 class="box-title">Data Surat Masuk Periode {{ $periode->periode }}</h3>
            ...
            <table id="example1" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" onclick="window.location.href='{{ route('surat-masuk.edit', [$surat->id]) }}'"
                        ...
                        <div class="modal-dialog modal-md" style="vertical-align:middle">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p>
                                Surat dari <b>{{ $surat->asal_surat }}</b> dengan nomor
